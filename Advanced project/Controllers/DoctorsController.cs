...
namespace Advanced_project.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            var myContext = _context.Doctors.Include(d => d.departement);
        ...
        public IActionResult Create([Bind("Did,D_name,D_age,D_address,Dept_no")] Doctor doctor)
        {
            ...
            ViewData["Dept_no"] = new SelectList(_context.Departments, "Deptno", "Deptno", doctor.Dept_no);
            return View(doctor);
        }
